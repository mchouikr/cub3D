...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   texture_handler_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: edelplan <edelplan@42.student.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/03 16:46:08 by edelplan          #+#    #+#             */
/*   Updated: 2025/02/18 15:39:15 by edelplan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_textures(t_data *data, t_mapdata *map)
{
	...
	map->door_txt_path = "./assets/textures/posterwall.xpm";
	...
	data->textures[DOOR] = mlx_xpm_file_to_image(data->mlx_ptr,
			map->door_txt_path, &size, &size);
	texture_handler_error(data);
	if (load_textures_buffer(data) != 0)
		return (ft_fprintf(2, "Error\nFailed to load textures.\n"),
			on_destroy(data), exit(1), 1);
	return (0);
}
